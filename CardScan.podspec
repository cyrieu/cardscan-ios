...
CardScan is a library for scanning credit cards.
  ...
  s.subspec 'Core' do |core|
    ...
    core.resource_bundles = { 'CardScan' => ['CardScan/Assets/*.xcassets', 'CardScan/Assets/*.storyboard', 'CardScan/Assets/*.mlmodelc', 'CardScan/Assets/*.strings'] }
  ...
  s.subspec 'Stripe' do |stripe|
    ...
    stripe.resource_bundles = { 'CardScan' => ['CardScan/Assets/*.xcassets', 'CardScan/Assets/*.storyboard', 'CardScan/Assets/*.mlmodelc', 'CardScan/Assets/*.strings'] }
